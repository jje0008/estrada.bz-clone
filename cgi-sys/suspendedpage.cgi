...
<body>
  <div>
    <img class="suspend-photo" src="//hostmonster-cdn.com/media/user/suspended_account/_hm/beback-soon.png" alt="Be back soon photo">
    <h2 class="be-back">Be back soon!</h2>
    <p class="website-moved">This website is under maintenance.</br>Check back tomorrow!</p>
    </br>
